...
- [x] 1.1 `resolve_pattern_rejects_unknown_contour_token` — build a
...
- [x] 1.2 `resolve_pattern_rejects_invalid_leap_token` — build a
...
- [x] 2.1 Confirm the existing resolver tests (`test_walking_jazz_bass`,
