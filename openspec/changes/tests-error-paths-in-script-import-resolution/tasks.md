...
- [ ] 1.1 `resolve_imports_passes_through_non_import_commands` —
...
- [ ] 1.2 `resolve_imports_inlines_imported_file_contents` —
  ...
  entries.
- [ ] 1.3 `resolve_imports_preserves_surrounding_command_order` —
...
- [ ] 1.4 `resolve_imports_handles_nested_imports_relative_to_importer`
...
- [ ] 2.1 `resolve_imports_errors_on_missing_file` — call
  ...
  path string.
- [ ] 2.2 `resolve_imports_errors_on_circular_import` — in a
...
- [ ] 3.1 In `openspec/specs/dsl-syntax/spec.md`, under the
