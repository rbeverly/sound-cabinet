...
- [ ] 1.1 `expand_motif_errors_when_no_motif` — build a `PatternFile::from_yaml`
...
- [ ] 1.2 `expand_motif_rejects_unknown_transformation` — build a
...
- [ ] 2.1 Confirm the existing motif tests (`test_expand_simple_motif`,
