...
- [ ] 1.1 In `src/dsl/expand.rs`, inside
...
- [ ] 1.2 Keep the existing loop body unchanged for positive intervals.

## 2. Test
- [ ] 2.1 Add a unit test `expand_rejects_zero_repeat_interval` in
  ...
  hang).
- [ ] 2.2 Add `expand_rejects_negative_repeat_interval` asserting the
