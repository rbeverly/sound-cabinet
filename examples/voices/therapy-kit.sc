...
voice bass_d  = (0.35 * sine(36.7) + 0.1 * triangle(73.4))  >> lowpass(250, 0.7) >> distort(1.3)
voice bass_bb = (0.35 * sine(29.1) + 0.1 * triangle(58.3))  >> lowpass(250, 0.7) >> distort(1.3)
voice bass_g  = (0.35 * sine(49.0) + 0.1 * triangle(98.0))  >> lowpass(250, 0.7) >> distort(1.3)
voice bass_a  = (0.35 * sine(55.0) + 0.1 * triangle(110.0)) >> lowpass(250, 0.7) >> distort(1.3)
...
voice mel_bb4 = (0.08 * triangle(466) + 0.05 * sine(464))  >> lowpass(1800, 0.4) >> decay(3) >> vibrato(4.0, 10.0)

// Lower octave for arp bass notes
voice mel_d4  = (0.07 * triangle(294) + 0.04 * sine(293))  >> lowpass(1400, 0.4) >> decay(3) >> vibrato(3.5, 8.0)
voice mel_e4  = (0.07 * triangle(329) + 0.04 * sine(328))  >> lowpass(1400, 0.4) >> decay(3) >> vibrato(3.5, 8.0)
voice mel_f4  = (0.07 * triangle(349) + 0.04 * sine(348))  >> lowpass(1400, 0.4) >> decay(3) >> vibrato(3.5, 8.0)
voice mel_g4  = (0.07 * triangle(392) + 0.04 * sine(391))  >> lowpass(1400, 0.4) >> decay(3) >> vibrato(3.5, 8.0)
voice mel_a3  = (0.07 * triangle(220) + 0.04 * sine(219))  >> lowpass(1400, 0.4) >> decay(3) >> vibrato(3.5, 8.0)
voice mel_bb3 = (0.07 * triangle(233) + 0.04 * sine(232))  >> lowpass(1400, 0.4) >> decay(3) >> vibrato(3.5, 8.0)
voice mel_c4  = (0.07 * triangle(262) + 0.04 * sine(261))  >> lowpass(1400, 0.4) >> decay(3) >> vibrato(3.5, 8.0)
